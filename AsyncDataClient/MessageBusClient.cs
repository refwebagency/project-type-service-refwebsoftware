...
namespace ProjectTypeService.AsyncDataClient
{
    public class MessageBusClient : IMessageBusClient
    {
        ...
        public void UpdatedProjectType(ProjectTypeUpdateAsyncDto projectTypeUpdateAsyncDto)
        {
            var message = JsonSerializer.Serialize(projectTypeUpdateAsyncDto);
            if(_connection.IsOpen)
            {
                Console.WriteLine("--> Updating projectType to MessageBus");
